    ...
    ?>
    	...
    	<div class="properties-left-block grid_left">
    	  <?php
    		...
    		echo $this->Form->input('Property.' .$i. '.property', array('type' => 'checkbox', 'class' => 'js-checkbox-list', 'checked' => $checked, 'legend' => false, 'label' => false, 'value' => $property['Property']['id'], 'div' => false));
    	 ...
    	 <div class="properties-right-block grid_5">
			...
			<?php echo $this->Form->input('Property.' .$i. '.price_per_week', array ('size' => '3', 'label' => 'Week','value'=>$property['Property']['price_per_week'],'div'=>false,'class'=>'js-input-price')); ?>
			</div>
			<div class="grid_2 alpha omega">
			<?php echo $this->Form->input('Property.' .$i. '.price_per_month', array ('size' => '3', 'label' => 'Month','value'=>$property['Property']['price_per_month'],'div'=>false,'class'=>'js-input-price')); ?>
			</div>
...
<?php
   ...
   <div class="select-block">
        ...
        <div class="clearfix save-filter-block">
          <?php
                echo $this->Form->submit(__l('Save'),array('class'=>'js-update-button inactive-search dc' ,'div' =>'save-block tb'));
            ?>
