...
<?php //debug($this->request->data); ?>
     ...
     <div class="padd-center">
					...
					<?php
                        echo $this->Form->input('Property.address', array('label' => __l('Address'),'type' => 'hidden','value'=>'argentina', 'id' => 'PropertyAddressSearch','info'=>'Address suggestion will be listed when you enter location.<br/>
							...
							<div id="js-geo-fail-address-fill-block" class="<?php echo $class;?>">
								<div class="clearfix">
									<div class="grid_16 omega alpha map-address-left-block address-input-block">
										<?php
											echo $this->Form->input('Property.latitude', array('id' => 'latitude', 'type' => 'hidden', 'value'=>'37'));
											echo $this->Form->input('Property.longitude', array('id' => 'longitude', 'type' => 'hidden', 'value'=>'37'));
