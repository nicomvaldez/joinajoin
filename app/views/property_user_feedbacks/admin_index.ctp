...
<?php if(empty($this->request->params['named']['simple_view'])) : ?>
	<?php echo $this->Form->create('PropertyUserFeedback' , array('type' => 'get', 'class' => 'normal search-form clearfix','action' => 'index')); ?>
...
?>
	<tr<?php echo $class;?>>
        <?php if(empty($this->request->params['named']['simple_view'])) : ?>
		  <td><?php echo $this->Form->input('PropertyUserFeedback.'.$propertyFeedback['PropertyUserFeedback']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$propertyFeedback['PropertyUserFeedback']['id'], 'label' => false, 'class' => $status_class.' js-checkbox-list')); ?></td>
        <?php endif; ?>
		<td class="actions">
        ...
        <li><?php echo $this->Html->link(__l('Edit'), array('action' => 'edit', $propertyFeedback['PropertyUserFeedback']['id']), array('class' => 'edit js-edit', 'title' => __l('Edit')));?></li>
		<li><?php echo $this->Html->link(__l('Delete'), array('action' => 'delete', $propertyFeedback['PropertyUserFeedback']['id']), array('class' => 'delete js-delete', 'title' => __l('Delete')));?></li>
         </ul>
        							</div>
		...
		<td class="dl"><?php echo $this->Html->cText($propertyFeedback['PropertyUserFeedback']['feedback']);?></td>
		<td class="dc">
			<?php
