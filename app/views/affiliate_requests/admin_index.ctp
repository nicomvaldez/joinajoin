...
<div class="add-block add-block clearfix grid_right">
...
<table class="list">
    <tr>
        ...
        <th class="dc"><?php echo $this->Paginator->sort(__l('Email Marketing'),'is_email_marketing');?></th>
...
?>
	<tr<?php echo $class;?>>
				...
				<div class="action-block">
                        <span class="action-information-block">
                            ...
                            <div class="action-inner-left-block">
								...
								<li>
		<span><?php echo $this->Html->link(__l('Edit'), array('action' => 'edit', $affiliateRequest['AffiliateRequest']['id']), array('class' => 'edit js-edit', 'title' => __l('Edit')));?></span>
		</li>
		<li>
		<span><?php echo $this->Html->link(__l('Delete'), array('action' => 'delete', $affiliateRequest['AffiliateRequest']['id']), array('class' => 'delete js-delete', 'title' => __l('Delete')));?></span></li></ul>
		</div>
        ...
        <td class="dc"><?php echo $this->Html->cText($affiliateRequest['AffiliateRequest']['special_promotional_method']);?></td>
