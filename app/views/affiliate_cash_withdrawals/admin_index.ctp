...
<div class="affiliateCashWithdrawals index js-response js-admin-index-autosubmit-over-block">
	...
	<div class="clearfix">
		<div class="select-block inbox-option">
			<?php $class = (!empty($this->request->data['Request']['filter_id']) && $this->request->data['Request']['filter_id'] == ConstMoreAction::Pending) ? 'active-filter' : null; ?>
			<span class="pending <?php echo $class; ?>"><?php echo $this->Html->link(__l('Pending').': '.$this->Html->cInt($pending), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Pending), array('escape' => false, 'title' => __l('Pending'))); ?></span>

			<?php $class = (!empty($this->request->data['Request']['filter_id']) && $this->request->data['Request']['filter_id'] == ConstMoreAction::Approved) ? 'active-filter' : null; ?>
			<span class="approved  <?php echo $class; ?>"><?php echo $this->Html->link(__l('Under Process').': '.$this->Html->cInt($approved), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Approved), array('escape' => false, 'title' => __l('Approved'))); ?></span>

			<?php $class = (!empty($this->request->data['Request']['filter_id']) && $this->request->data['Request']['filter_id'] == ConstMoreAction::Rejected) ? 'active-filter' : null; ?>
			<span class="rejected <?php echo $class; ?>"><?php echo $this->Html->link(__l('Rejected').': '.$this->Html->cInt($rejected), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Rejected), array('escape' => false, 'title' => __l('Rejected'))); ?></span>

			<?php $class = (!empty($this->request->data['Request']['filter_id']) && $this->request->data['Request']['filter_id'] == ConstMoreAction::Success) ? 'active-filter' : null; ?>
			<span class="success <?php echo $class; ?>"><?php echo $this->Html->link(__l('Success').': '.$this->Html->cInt($success), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Success), array('escape' => false, 'title' => __l('Success'))); ?></span>

			<?php $class = (!empty($this->request->data['Request']['filter_id']) && $this->request->data['Request']['filter_id'] == ConstMoreAction::Failed) ? 'active-filter' : null; ?>
			<span class="failed <?php echo $class; ?>"><?php echo $this->Html->link(__l('Failed').': '.$this->Html->cInt($failed), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Failed), array('escape' => false, 'title' => __l('Failed'))); ?></span>

			<?php $class = (empty($this->request->data['Request']['filter_id'])) ? 'active-filter' : null; ?>
			<span class="all <?php echo $class; ?>"><?php echo $this->Html->link(__l('All').': '.$this->Html->cInt($approved + $pending + $rejected + $success + $failed), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => 'all'), array('escape' => false, 'title' => __l('All'))); ?></span>
			</div>
    </div>
 ...
 <div class="overflow-block">
    <table class="list">
        <tr>
            ...
            <?php endif;?>        
            <th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Requested on'),'AffiliateCashWithdrawal.created');?></div></th>
            ...
            <?php if(!empty($this->request->params['named']['filter_id']) && $this->request->params['named']['filter_id'] == ConstAffiliateCashWithdrawalStatus::Success) { ?>
                <th class="dr"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Paid on'),'AffiliateCashWithdrawal.modified');?></div></th>
            <?php } ?>
            
            <?php if(!empty($this->request->params['named']['filter_id']) && $this->request->params['named']['filter_id'] == 'all') { ?>
                <th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Status'),'AffiliateCashWithdrawal.name');?></div></th>
            <?php } ?>
        </tr>
    <?php
