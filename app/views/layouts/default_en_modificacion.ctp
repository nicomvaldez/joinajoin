...
<head>
	    ...
	    <link href="/assets/css/ajustes.css" rel="stylesheet">
    ...
    <footer style="padding-top: 15px; padding-bottom: 10px;">
        <div class="container">
            <div class="row">
                ...
                <div class="span3">
                    <h5><span class="colored">///</span> Join a Join Company.</h5>
                    <p>Join a Join is a marketplace to find things to do for fun, rentals, tours and activities offered by local experts or amateurs.</p>
                    <hr class="visible-phone">
                </div>
            ...
            <div class="row">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="span6">
                            <span class="pull-right visible-desktop"><span class="undercolored"><a href="#">Home</a></span> / <span class="undercolored"><a href="#">Features</a></span> / <span class="undercolored"><a href="#">Pages</a></span> / <span class="undercolored"><a href="#">Blog</a></span> / <span class="undercolored"><a href="#">Contact</a></span></span>
                        </div>
                    </div>
                </div>
            </div>
