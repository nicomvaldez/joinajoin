	...
	<?php
		...
		<div class="clearfix translation-index-block">
            ...
            <div class="translation-right-block grid_left">
				<div class="submit-block clearfix">
                <?php echo $this->Form->submit('Google Translate', array('name' => 'data[Translation][googleTranslate]', 'disabled' => $disabled));	?>
				</div>
                <span class="info"><?php echo __l('It will automatically translate site labels into selected language with Google. You may then edit necessary labels.');?> </span>
