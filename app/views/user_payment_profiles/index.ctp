...
<div class="form">
	<div class="grid_17 side1 js-toggle-show-block">
		...
		?> <div class="clearfix counter-block">
			...
			<div class="clearfix add-block grid_right payment-add">
				<?php echo $this->Html->link(__l('Add'), array('controller' => 'user_payment_profiles', 'action' => 'add'), array('class' => "add", 'title' => __l('Add'))); ?>
			</div>
			</div>
						...
						<div class="actions-block">
							<div class="actions round-5-left">
								...
								<?php if (empty($userPaymentProfile['UserPaymentProfile']['is_default'])): ?>
									<span><?php echo $this->Html->link(__l('Set as default'), array('action' => 'update', $userPaymentProfile['UserPaymentProfile']['id']), array('class' => 'suspend', 'title' => __l('Set as default')));?></span>
								<?php endif; ?>
							</div>
						</div>
					</td>
