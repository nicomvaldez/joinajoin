	...
	<fieldset>
		<?php
			...
			foreach($paymentGatewaySettings as $paymentGatewaySetting) {
				...
				if($paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'is_enable_for_property_listing_fee'):
					$options['label'] = __l('Enable for property listing');
				elseif($paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'is_enable_for_property_verified_fee'):
				...
				elseif($paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'is_enable_for_book_a_property'):
				...
				if ($paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'is_enable_for_property_listing_fee' || $paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'is_enable_for_property_verified_fee' || $paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'is_enable_for_add_to_wallet' || $paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'is_enable_for_book_a_property'):
		...
		<?php
			...
			<?php if($paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'payee_account' || $paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'receiver_emails'): ?>
				<?php if($z == 0):?>
					<fieldset class="form-block1 round-5">
						<legend class="round-5"><?php echo __l('Payee Details'); ?></legend>
				<?php endif; ?>
			...
			<?php if($paymentGatewaySetting['PaymentGatewaySetting']['key'] == 'MRB_ID' ):?>
				<fieldset class="form-block1 round-5">
					<legend class="round-5"><?php echo __l('Merchant Referral Bonus ID'); ?></legend>  	
					<div class="info-details">
