...
<div class="userCashWithdrawals index js-response">
	<div class="clearfix">
		<div class="select-block inbox-option">			
			...
			<span class="pending <?php echo $class; ?>"><?php echo $this->Html->link(__l('Pending').': '.$this->Html->cInt($pending), array('controller' => 'user_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstWithdrawalStatus::Pending), array('escape' => false, 'title' => __l('Pending'), 'escape' => false)); ?></span>
			...
			<span class="approved <?php echo $class; ?>"><?php echo $this->Html->link(__l('Under Process').': '. $this->Html->cInt($approved), array('controller' => 'user_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstWithdrawalStatus::Approved), array('escape' => false, 'title' => __l('Approved'), 'escape' => false)); ?></span>
			...
			<span class="rejected <?php echo $class; ?>"><?php echo $this->Html->link(__l('Rejected').': '.$this->Html->cInt($rejected), array('controller' => 'user_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstWithdrawalStatus::Rejected), array('escape' => false, 'title' => __l('Rejected'), 'escape' => false)); ?></span>
			...
			<span class="success <?php echo $class; ?>"><?php echo $this->Html->link(__l('Success').': '.$this->Html->cInt($success), array('controller' => 'user_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstWithdrawalStatus::Success), array('escape' => false, 'title' => __l('Success'), 'escape' => false)); ?></span>
			...
			<span class="failed <?php echo $class; ?>"><?php echo $this->Html->link(__l('Failed').': '.$this->Html->cInt($failed), array('controller' => 'user_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstWithdrawalStatus::Failed), array('escape' => false, 'title' => __l('Failed'), 'escape' => false)); ?></span>

			<?php $class = (empty($this->request->data['Request']['filter_id'])) ? 'active-filter' : null; ?>
			<span class="all <?php echo $class; ?>"><?php echo $this->Html->link(__l('All').': '.$this->Html->cInt(($approved + $pending + $rejected + $success + $failed)), array('controller' => 'user_cash_withdrawals', 'action' => 'index', 'filter_id' => 'all'), array('escape' => false, 'title' => __l('All'), 'escape' => false)); ?></span>
		</div>
    </div>
		<?php 
    ...
    <table class="list">
        <tr>
            ...
            <?php endif;?>        
            <th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Requested on'),'UserCashWithdrawal.created');?></div></th>
            ...
            <?php if(!empty($this->request->params['named']['filter_id']) && $this->request->params['named']['filter_id'] == ConstWithdrawalStatus::Success) { ?>
                <th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Paid on'),'UserCashWithdrawal.modified');?></div></th>
            <?php } ?>
            <?php if(!empty($this->request->params['named']['filter_id']) && $this->request->params['named']['filter_id'] == 'all') { ?>
                <th class="dc"><div class="js-pagination"><?php echo $this->Paginator->sort(__l('Status'),'WithdrawalStatus.name');?></div></th>
            <?php } ?>
        </tr>
    <?php
