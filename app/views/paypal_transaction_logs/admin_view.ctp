...
<div class="paypalTransactionLogs view">
	<dl class="list"><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Date Added');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalTransactionLog['PaypalTransactionLog']['created']) ? $this->Html->cDateTimeHighlight($paypalTransactionLog['PaypalTransactionLog']['created']) : '-';?></dd>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Payment Date');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalTransactionLog['PaypalTransactionLog']['payment_date']) ? $this->Html->cDateTimeHighlight($paypalTransactionLog['PaypalTransactionLog']['payment_date']) : '-';?></dd>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Mc Gross');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalTransactionLog['PaypalTransactionLog']['mc_gross']) ? $this->Html->cCurrency($paypalTransactionLog['PaypalTransactionLog']['mc_gross']) : '-';?></dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Mc Fee');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo !empty($paypalTransactionLog['PaypalTransactionLog']['mc_fee']) ? $this->Html->cCurrency($paypalTransactionLog['PaypalTransactionLog']['mc_fee']) : '-';?></dd>
		...
		<?php if(!empty($paypalTransactionLog['PaypalTransactionLog']['is_mass_pay'])) :?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('Mass Pay Response');?></dt>
