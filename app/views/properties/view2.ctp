							...
							<div class="properties-left">
								...
								<?php if(!empty($amenities_list)) { ?>
									<ol class="amenities-list clearfix js-amenity">
										<?php //que mal esta programado esto! pg
										...
										<?php $amenity_class_name = 'amenities-am-' . $key; ?>
											...
											<?php if($class == 'allowed'){?>
												<li class="clearfix" style="width: 135px !important;">
													<span></span>
								...
								<?php if (!empty($holiday_list)) {?>
									<ol class="amenities-list clearfix">
										...
										<?php if($class == 'allowed'){ ?>
											<li style="width: 135px !important;">	
						...
						<div class="book-center clearfix">
							<div class="browse js-responses">
								...
								<div class="form-block city-search-block-top">
									...
									<div class="js-calender-formfield">
										<div class="clearfix checkin-form-field">
											<?php
                                                echo $this->Form->input('checkin',array('class'=>'datepickerbnb', 'label'=> 'Check In', 'type'=> 'text'));
                                                echo $this->Form->input('checkout',array('class'=>'datepickerbnb', 'label'=> 'Check Out', 'type'=> 'text'));
                                                //echo $this->Form->input('resultado', array('id'=> 'res'));
