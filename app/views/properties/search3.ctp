...
<?php
  echo $this->Form->create('Property', array('id'=> 'KeywordsSearchForm','class' => 'check-form js-search-map js-ajax-search-form norma keywords','action'=>'index')); ?>
        ...
        <div class="block2 clearfix">
           ...
           <div class="clearfix">
       <!-- Grace Basilio - 22/02/2012 :: Let's hide this sucker -->
