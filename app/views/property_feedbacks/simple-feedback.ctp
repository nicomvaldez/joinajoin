...
<?php if(empty($this->request->params['isAjax'])): ?>
	...
	<ul class="clearfix yes-no-link">
		<li class="yes"><?php echo $this->Html->link(__l('Yes'), array('controller' => 'property_feedbacks', 'action' => 'add', 'property_order_id' => $this->request->params['named']['property_order_id'], 'view_type' => 'simple-feedback','selected' => 'yes', 'property_type_id' => $message['property_type_id']), array('title' => __l('Yes'), 'rel' => 'address:/' . r(' ', '_', 'Yes'), 'escape' => false)); ?></li>
		<li class="no"><?php echo $this->Html->link(__l('No'), array('controller' => 'property_feedbacks', 'action' => 'add', 'property_order_id' => $this->request->params['named']['property_order_id'], 'view_type' => 'simple-feedback','selected' => 'no', 'property_type_id' => $message['property_type_id']), array('title' => __l('No'), 'rel' => 'address:/' . r(' ', '_', 'No'), 'escape' => false)); ?></li>
	</ul>
