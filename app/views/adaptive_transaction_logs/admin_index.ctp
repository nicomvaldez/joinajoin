...
<table class="list">
    <tr>
        ...
        <th><?php echo $this->Paginator->sort(__l('Id'), 'id');?></th>
        <th><?php echo $this->Paginator->sort(__l('Created'), 'created');?></th>
        <th><?php echo $this->Paginator->sort(__l('Foreign'), 'foreign_id');?></th>
		<th><?php echo $this->Paginator->sort(__l('Class'), 'class');?></th>
		<th><?php echo $this->Paginator->sort(__l('Transaction'), 'transaction_id');?></th>
        ...
        <th><?php echo $this->Paginator->sort(__l('Primary'), 'primary');?></th>
        <th><?php echo $this->Paginator->sort(__l('Invoice'), 'invoice_id');?></th>
        <th><?php echo $this->Paginator->sort(__l('Refunded Amount'), 'refunded_amount');?></th>
        <th><?php echo $this->Paginator->sort(__l('Pending Refund'), 'pending_refund');?></th>
        <th><?php echo $this->Paginator->sort(__l('Sender Transaction'), 'sender_transaction_id');?></th>
        <th><?php echo $this->Paginator->sort(__l('Sender Transaction Status'), 'sender_transaction_status');?></th>
        <th><?php echo $this->Paginator->sort(__l('TimeStamp'), 'timestamp');?></th>
        <th><?php echo $this->Paginator->sort(__l('Acknowledgment'), 'ack');?></th>
        <th><?php echo $this->Paginator->sort(__l('Correlation'), 'correlation_id');?></th>
        <th><?php echo $this->Paginator->sort(__l('Build'), 'build');?></th>
        <th><?php echo $this->Paginator->sort(__l('Currency Code'), 'currency_code');?></th>
        <th><?php echo $this->Paginator->sort(__l('Sender Email'), 'sender_email');?></th>
        <th><?php echo $this->Paginator->sort(__l('Status'), 'status');?></th>
        <th><?php echo $this->Paginator->sort(__l('Tracking'), 'tracking_id');?></th>
        <th><?php echo $this->Paginator->sort(__l('Pay Key'), 'pay_key');?></th>
        <th><?php echo $this->Paginator->sort(__l('Action Type'), 'action_type');?></th>
        <th><?php echo $this->Paginator->sort(__l('Fees Payer'), 'fees_payer');?></th>
		<th><?php echo $this->Paginator->sort(__l('Memo'), 'memo');?></th>
        <th><?php echo $this->Paginator->sort(__l('Reverse All Parallel Payments On Error'), 'reverse_all_parallel_payments_on_error');?></th>
        <th><?php echo $this->Paginator->sort(__l('Refund Status'), 'refund_status');?></th>
        <th><?php echo $this->Paginator->sort(__l('Refund Net Amount'), 'refund_net_amount');?></th>
        <th><?php echo $this->Paginator->sort(__l('Refund Fee Amount'), 'refund_fee_amount');?></th>
        <th><?php echo $this->Paginator->sort(__l('Refund Gross Amount'), 'refund_gross_amount');?></th>
        <th><?php echo $this->Paginator->sort(__l('Total Of Alll Refunds'), 'total_of_alll_refunds');?></th>
        <th><?php echo $this->Paginator->sort(__l('Refund Has Become Full'), 'refund_has_become_full');?></th>
        <th><?php echo $this->Paginator->sort(__l('Encrypted Refund Transaction'), 'encrypted_refund_transaction_id');?></th>
        <th><?php echo $this->Paginator->sort(__l('Refund Transaction Status'), 'refund_transaction_status');?></th>
    </tr>
<?php
...
?>
	<tr<?php echo $class;?>>
       ...
       <li> <span><?php echo $this->Html->link(__l('View'), array('controller' => 'adaptive_transaction_logs', 'action' => 'view', $adaptiveTransactionLog['AdaptiveTransactionLog']['id']), array('class' => 'view', 'title' => __l('View')));?></span></li></ul>
            </div>
		...
		<td><?php echo $this->Html->siteCurrencyFormat($adaptiveTransactionLog['AdaptiveTransactionLog']['amount']);?></td>
