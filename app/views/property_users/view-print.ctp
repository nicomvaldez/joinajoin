...
<table  style="border-bottom:1px dashed #000000; padding:10px 0 15px 0;"width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="62%"><span style="color:#0062DD;font-size:17px;font-weight:bold;"><?php echo $this->Html->cText($propertyUser['Property']['title']);?></span></td>
    <td width="25%"><div align="right" class="style2"><strong><?php echo __l('Phone:'); ?></strong></div></td>
    <td width="13%"><div align="right" class="style3"><?php echo $this->Html->cText($propertyUser['Property']['phone']) ;?></div></td>
  </tr>
  <tr>
    ...
    <td><div align="right" class="style3"><?php echo $this->Html->cText($propertyUser['Property']['backup_phone']);?></div></td>
  </tr>
</table>
<?php 
	$start=split('-',$propertyUser['PropertyUser']['checkin']);
	$end=split('-',$propertyUser['PropertyUser']['checkout']);
	$checkin_date = strtotime($propertyUser['PropertyUser']['checkin']);
	$checkout_date = strtotime($propertyUser['PropertyUser']['checkout']);
  ...
  <tr>
	...
	<?php
		$current_user_details = array(
			...
			'user_type_id' => $propertyUser['Property']['User']['user_type_id'],
			'id' => $propertyUser['Property']['User']['id'],
			'fb_user_id' => $propertyUser['Property']['User']['fb_user_id']
		);
		$current_user_details['UserAvatar'] = array(
			'id' => $propertyUser['Property']['User']['attachment_id']
		);
...
<td width="9%" style="vertical-align:top;"><div align="left"> <?php
    ...
    <td width="62%"><div align="right"><?php if(!empty($propertyUser['Property']['address'])): ?>
				<?php $map_zoom_level = !empty($propertyUser['Property']['map_zoom_level']) ? $propertyUser['Property']['zoom_level'] : '10';?>
							<?php echo $this->Html->image($this->Html->formGooglemap($propertyUser['Property'],'284x224'));?>
				<?php endif; ?></div></td>
  </tr>
</table>
...
<table style="padding:10px 0 0 0;"width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr><td><img src="../../img/cut-bg.png" title="user" /></td></tr></table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><p>&copy;<?php echo __l('2011'); ?> <a href="<?php echo Router::url('/', true); ?>" title="<?php echo Configure::read('site.name'); ?>"><?php echo configure::read('site.name'); ?></a><?php echo __l('. All rights reserved.'); ?></p>
      </td>
  </tr>
</table>
