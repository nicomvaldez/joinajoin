...
class AffiliateCashWithdrawal extends AppModel
{
    ...
    function affiliate_masspay_ipn_process($userCashWithdrawal_id, $userCashWithdrawal_response, $gateway_id = ConstPaymentGateways::PayPal, $logTable = 'PaypalTransactionLog')
    {        
