...
class PaypalPlatform
{
    ...
    var $API_AppID = '';
    var $API_Endpoint = '';
    var $API_Adaptive_Endpoint = '';
    var $API_Account_Endpoint = '';
    var $USE_PROXY = false;
    ...
    */
    ...
    '--------------------------------------------------------------------------------------------------------------------------------------------
    */
    function CallCreateAccount($preferredLanguageCode, $accountType, $firstName, $lastName, $dateOfBirth, $address1, $address2, $city, $state, $zip, $countryCode, $citizenshipCountryCode, $contactPhoneNumber, $currencyCode, $emailAddress, $returnUrl, $cancelUrl, $notificationURL, $referralId) 
    {
        // required fields
    ...
    '--------------------------------------------------------------------------------------------------------------------------------------------
    */
    function CallGetVerifiedStatus($email, $first_name, $last_name) 
    {
        // required fields
        $nvpstr = '';
        if ("" != $email) {
    ...
    '--------------------------------------------------------------------------------------------------------------------------------------------
    */
    function CallCancelPreapproval($preapprovalKey) 
    {
        // required fields
    ...
    */
    ...
    '--------------------------------------------------------------------------------------------------------------------------------------------
    */
    function CallExecutePayment($payKey) 
    {
        $nvpstr = '';
    ...
    '--------------------------------------------------------------------------------------------------------------------------------------------
    */
	function CallSetPaymentOptions($payKey, $options)
    {
		$nvpstr = '';
        /* Make the Pay call to PayPal */
    ...
    */
    ...
    '--------------------------------------------------------------------------------------------------------------------------------------------
    */
    function CallPreapproval($returnUrl, $cancelUrl, $currencyCode, $startingDate, $endingDate, $maxTotalAmountOfAllPayments, $senderEmail, $maxNumberOfPayments, $paymentPeriod, $dateOfMonth, $dayOfWeek, $maxAmountPerPayment, $maxNumberOfPaymentsPerPeriod, $pinType, $ipnNotificationUrl) 
    {
    ...
    */
    ...
    function hash_account_call($methodName, $nvpStr, $sandboxEmailAddress = '', $referralId = '') 
    {
    ...
    function hash_api_call($methodName, $nvpStr = '') 
    {
        //setting the curl parameters.
        $ch = curl_init();
