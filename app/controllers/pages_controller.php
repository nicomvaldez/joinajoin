...
class PagesController extends AppController
{
    ...
    public function admin_add()
    {
        ...
        if (!empty($this->request->data)) {
            ...
            if ($this->Page->validates()) {
                ...
                if ($this->request->data['Page']['Preview']) {
    ...
    public function view($slug = null)
    {
        ...
        $pageFindReplace = array(
            ...
            '##SITE_CONTACT_PHONE##' => Configure::read('EmailTemplate.contact_phone') ,
            '##SITE_CONTACT_EMAIL##' => "<a href='mailto:" . Configure::read('EmailTemplate.admin_email') . "'>" . Configure::read('EmailTemplate.admin_email') . "</a>",
