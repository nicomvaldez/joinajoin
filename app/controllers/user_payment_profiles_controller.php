...
class UserPaymentProfilesController extends AppController
{
    ...
    {
        if (!$this->UserPaymentProfile->isPaymentGatewayEnabled(ConstPaymentGateways::AuthorizeNet)) {
    ...
    public function edit($id)
    {
        ...
        if (!empty($this->request->data)) {
            ...
            if (empty($check_expire)) {
                ...
                $payment_profile_id = $this->Payment->_updateCimPaymentProfile($data);
            ...
            $data['customerProfileId'] = $user['User']['cim_profile_id'];
            $data['customerPaymentProfileId'] = $userPaymentProfile['UserPaymentProfile']['cim_payment_profile_id'];
            $credit_info = $this->Payment->_getCimPaymentProfile($data);
    ...
    public function delete($id = null)
    {
        ...
        $data['customerProfileId'] = $user['User']['cim_profile_id'];
        $data['customerPaymentProfileId'] = $userPaymentProfile['UserPaymentProfile']['cim_payment_profile_id'];
        if ($this->Payment->_deleteCimPaymentProfile($data)) {
