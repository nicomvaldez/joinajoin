<?php
class BnbpropertiesController extends AppController
{
    public $name = 'Bnbproperties';
    public $lastDays;
    public $uses = array(
        'Bnbproperty',
        'Request',
    ...
    public function beforeFilter()
    {
        $this->Security->disabledFields = array(
            'Attachment',
            'Attachment.file',
            'Bnbproperty.latitude',
            'Bnbproperty.longitude',
            'Bnbproperty.ne_latitude',
            'Bnbproperty.ne_longitude',
            'Bnbproperty.sw_latitude',
            'Bnbproperty.sw_longitude',
            'Bnbproperty.zoom_level',
            'Bnbproperty.country_id',
            'Bnbproperty.step1',
            'Bnbproperty.step2',
            'Bnbproperty.step3',
            'Bnbproperty.step4',
    ...
    public function search()
    {
        ...
        $this->request->data['Bnbproperty']['checkout'] = getCheckoutDate(date('Y-m-d'));
    }
    public function index($hash_keyword = '', $salt = '')
    {
       $this->_redirectPOST2Named(array(
        ...
        if (!empty($hash_keyword) && !empty($salt)) {
            ...
            if ($salt1 != $salt) {
                $this->redirect(array(
                    'controller' => 'bnb_properties',
                    'action' => 'search',
                ));
            }
            $named_array = $this->Bnbproperty->getSearchKeywords($hash_keyword, $salt);
            ...
            if (!empty($this->request->params['named']['city'])) {
                $CityList = $this->Bnbproperty->City->find('first', array(
                    'conditions' => array(
        ...
        $conditions = array();
        $conditions['Bnbproperty.admin_suspend'] = 0;
        $conditions['Bnbproperty.is_approved'] = 1;
        $conditions['Bnbproperty.is_active'] = 1;
        $conditions['Bnbproperty.is_paid'] = 1;
        $exact_match = array();
        ...
        if (!empty($this->request->params['named']['user']) && !empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'user') {
            $is_searching = true;
            $conditions['Bnbproperty.user_id'] = $this->request->params['named']['user'];
        }
        if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'collection') {
            ...
            if (!empty($slug)) {
                $is_searching = true;
                $collection = $this->Bnbproperty->Collection->find('first', array(
                    'conditions' => array(
                ...
                $property_ids = $this->Bnbproperty->CollectionsProperty->find('list', array(
                    'conditions' => array(
                        'CollectionsBnbproperty.collection_id' => $collection['Collection']['id'],
                    ) ,
                    'fields' => array(
                        'CollectionsBnbproperty.id',
                        'CollectionsBnbproperty.property_id',
                    ) ,
                    'recursive' => -1
                ));
                $collections = $this->Bnbproperty->Collection->find('first', array(
                    'conditions' => array(
                ...
                if (count($property_ids) > 0) {
                    $conditions['Bnbproperty.id'] = $property_ids;
                }
                ...
                $property_list = array();
                if (!empty($roomtype)) {
                    $this->request->data['Bnbproperty']['RoomType'] = explode(',', $roomtype);
                    if (count($this->request->data['Bnbproperty']['RoomType']) > 0) {
                        $conditions['Bnbproperty.room_type_id'] = $this->request->data['Bnbproperty']['RoomType'];
                    }
                }
                if (!empty($min_beds)) {
                    $this->request->data['Bnbproperty']['min_beds'] = $min_beds;
                    $conditions['Bnbproperty.beds >='] = $this->request->data['Bnbproperty']['min_beds'];
                }
                if (!empty($min_bedrooms)) {
                    $this->request->data['Bnbproperty']['min_bedrooms'] = $min_bedrooms;
                    $conditions['Bnbproperty.bed_rooms >='] = $this->request->data['Bnbproperty']['min_bedrooms'];
                }
                if (!empty($min_bathrooms)) {
                    $this->request->data['Bnbproperty']['min_bathrooms'] = $min_bathrooms;
                    $conditions['Bnbproperty.bath_rooms >='] = $this->request->data['Bnbproperty']['min_bathrooms'];
                }
                if (!empty($language)) {
                    $this->request->data['Bnbproperty']['language'] = explode(',', $language);
                    $host_languages = $this->Bnbproperty->User->UserProfile->find('list', array(
                        'conditions' => array(
                            'UserProfile.language_id' => $this->request->data['Bnbproperty']['language']
                        ) ,
                        'fields' => array(
                            'UserProfile.id',
                            'UserProfile.user_id'
                    ...
                    $conditions['Bnbproperty.user_id'] = $host_languages;
                }
                if (!empty($network_level)) {
                    $this->request->data['Bnbproperty']['network_level'] = explode(',', $network_level);
                    $tmp_user_ids = array();
                    foreach($this->request->data['Bnbproperty']['network_level'] as $tmp_network_level) {
                    ...
                    if (!empty($tmp_user_ids)) {
                        $conditions['Bnbproperty.user_id'] = $tmp_user_ids;
                    } else {
                        $conditions['Bnbproperty.user_id ='] = '';
                    }
                }
                if (!empty($holidaytype)) {
                    $this->request->data['Bnbproperty']['HolidayType'] = explode(',', $holidaytype);
                    $holidayTypes = $this->Bnbproperty->HolidayTypeProperty->find('all', array(
                        'conditions' => array(
                            'HolidayTypeBnbproperty.holiday_type_id' => $this->request->data['Bnbproperty']['HolidayType']
                        ) ,
                        'fields' => array(
                            'HolidayTypeBnbproperty.holiday_type_id',
                            'HolidayTypeBnbproperty.property_id'
                        ) ,
                        'recursive' => -1
                    ));
                    ...
                    if (!empty($total_holiday_type_list)) {
                        $holiday_list = $total_holiday_type_list[current($this->request->data['Bnbproperty']['HolidayType']) ];
                        next($this->request->data['Bnbproperty']['HolidayType']);
                        foreach($this->request->data['Bnbproperty']['HolidayType'] as $holiday_type) {
                            $holiday_list = array_intersect($holiday_list, $total_holiday_type_list[$holiday_type]);
                        }
                    }
                }
                if (!empty($propertytype)) {
                    $this->request->data['Bnbproperty']['PropertyType'] = explode(',', $propertytype);
                    if (count($this->request->data['Bnbproperty']['PropertyType']) > 0) {
                        $conditions['Bnbproperty.property_type_id'] = $this->request->data['Bnbproperty']['PropertyType'];
                    }
                }
                if (!empty($amenity)) {
                    $this->request->data['Bnbproperty']['Amenity'] = explode(',', $amenity);
                    $amenitiesProperties = $this->Bnbproperty->AmenitiesProperty->find('all', array(
                        'conditions' => array(
                            'AmenitiesBnbproperty.amenity_id' => $this->request->data['Bnbproperty']['Amenity']
                        ) ,
                        'fields' => array(
                            'AmenitiesBnbproperty.amenity_id',
                            'AmenitiesBnbproperty.property_id'
                        ) ,
                        'recursive' => -1
                    ));
                    ...
                    $amenity_list = $total_amenity_list[current($this->request->data['Bnbproperty']['Amenity']) ];
                    next($this->request->data['Bnbproperty']['Amenity']);
                    foreach($this->request->data['Bnbproperty']['Amenity'] as $amenity) {
                ...
                if (!empty($property_list) && count($property_list) > 0) {
                    $conditions['Bnbproperty.id'] = array_intersect($property_ids, $property_list);
                }
                if (!empty($rangefrom)) {
                    $conditions['Bnbproperty.price_per_night >='] = $rangefrom;
                    $exact_match['Bnbproperty.price_per_night >='] = $rangefrom;
                }
                if (!empty($rangeto) && $rangeto != '300+') {
                    $conditions['Bnbproperty.price_per_night <='] = $rangeto;
                }
                if (!empty($depositfrom)) {
                    $conditions['Bnbproperty.security_deposit >='] = $depositfrom;
                    $exact_match['Bnbproperty.security_deposit >='] = $depositfrom;
                }
                if (!empty($depositeto) && $depositto != '300+') {
                    $conditions['Bnbproperty.security_deposit <='] = $depositto;
                }
                if (!empty($search_keyword['named']['keyword'])) {
                    $conditions['Bnbproperty.title LIKE '] = '%' . $search_keyword['named']['keyword'] . '%';
                }
                if (!empty($search_keyword['named']['sw_latitude'])) {
                    ...
                    $conditions['Bnbproperty.latitude BETWEEN ? AND ?'] = array(
                        $lat1,
                        $lat2
                    );
                    $conditions['Bnbproperty.longitude BETWEEN ? AND ?'] = array(
                        $lon1,
                        $lon2
                    );
                }
        ...
        if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'favorite') {
            ...
            $is_searching = true;
            $propertyFavorites = $this->Bnbproperty->PropertyFavorite->find('list', array(
                'conditions' => array(
            ...
            $conditions['Bnbproperty.id'] = $propertyFavorites;
            //}
            $user = $this->Bnbproperty->User->find('first', array(
                'conditions' => array(
        ...
        if (!empty($this->request->params['named']['user_id']) && !empty($this->request->params['named']['property_id'])) {
            $conditions['Bnbproperty.user_id'] = $this->request->params['named']['user_id'];
            $conditions['Bnbproperty.id !='] = $this->request->params['named']['property_id'];
        }
        if (!empty($this->request->params['named']['property']) && $this->request->params['named']['property'] == 'my_properties') {
            $requests = $this->Bnbproperty->PropertiesRequest->Request->find('first', array(
                'conditions' => array(
            ...
            $conditions['Bnbproperty.user_id'] = $this->Auth->user('id');
            ...
            $match_conditions['Bnbproperty.user_id'] = $this->Auth->user('id');
            $match_conditions['Bnbproperty.is_active'] = 1;
            $match_conditions['Bnbproperty.latitude BETWEEN ? AND ?'] = array(
                $lat1,
                $lat2
            );
            $match_conditions['Bnbproperty.longitude BETWEEN ? AND ?'] = array(
                $lon1,
                $lon2
            );
            $match_conditions['Bnbproperty.price_per_night <='] = $requests['Request']['price_per_night'];
            $days = getCheckinCheckoutDiff($requests['Request']['checkin'], getCheckoutDate($requests['Request']['checkout']));
            $match_conditions['Bnbproperty.minimum_nights <='] = $days;
            $match_conditions['AND'][]['OR'] = array(
                'Bnbproperty.maximum_nights <=' => $days,
                'Bnbproperty.maximum_nights =' => 0
            );
            $match_conditions['Bnbproperty.accommodates >='] = $requests['Request']['accommodates'];
            $match_conditions['Bnbproperty.accommodates !='] = 0;
            ...
            $booking_list = $this->Bnbproperty->PropertyUser->find('list', array(
            ...
            $not_available_list = $this->Bnbproperty->CustomPricePerNight->find('list', array(
            ...
            if (!empty($booking_list)) {
                $match_conditions['NOT']['Bnbproperty.id'] = $booking_list;
            }
            $available_list = $this->Bnbproperty->find('list', array(
        ...
        if (!empty($this->request->params['named']['city_id']) && !empty($this->request->params['named']['property_id'])) {
            $conditions['Bnbproperty.id !='] = $this->request->params['named']['property_id'];
            $nearby_property = $this->Bnbproperty->find('first', array(
                'conditions' => array(
                    'Bnbproperty.id' => $this->request->params['named']['property_id']
                ) ,
                'recursive' => -1,
            ));
            //distance based search
            ...
            $fields = "3956 * 2 * ASIN(SQRT(  POWER(SIN((Bnbproperty.latitude - " . $nearby_property['Property']['latitude'] . ") * pi()/180 / 2), 2) + COS(Bnbproperty.latitude * pi()/180) *  COS(" . $nearby_property['Property']['latitude'] . " * pi()/180) * POWER(SIN((Bnbproperty.longitude - " . $nearby_property['Property']['longitude'] . ") * pi()/180 / 2), 2)  )) as distance";
        }
        if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'myproperties') {
            ...
            unset($conditions['Bnbproperty.admin_suspend']);
            unset($conditions['Bnbproperty.is_approved']);
            unset($conditions['Bnbproperty.is_active']);
            unset($conditions['Bnbproperty.is_paid']);
            if (isset($this->request->params['named']['status']) && $this->request->params['named']['status'] == 'pending') {
                $conditions['Bnbproperty.is_paid'] = 0;
                ...
                $conditions['Bnbproperty.is_active'] = 0;
            } elseif (isset($this->request->params['named']['status']) && $this->request->params['named']['status'] == 'verified') {
                $conditions['Bnbproperty.is_verified'] = ConstVerification::Verified;
            } elseif (isset($this->request->params['named']['status']) && $this->request->params['named']['status'] == 'notverified') {
                $conditions['Bnbproperty.is_verified'] = NULL;
            } elseif (isset($this->request->params['named']['status']) && $this->request->params['named']['status'] == 'waiting_for_verification') {
                $conditions['Bnbproperty.is_verified'] = ConstVerification::WaitingForVerification;
            } elseif (isset($this->request->params['named']['status']) && $this->request->params['named']['status'] == 'waiting_for_approval') {
                $conditions['Bnbproperty.is_approved'] = 0;
            } elseif (isset($this->request->params['named']['status']) && $this->request->params['named']['status'] == 'imported') {
                $conditions['Bnbproperty.is_imported_from_airbnb'] = 1;
            }
            //Count Querys
            $this->set('all_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id')
                ) ,
                'recursive' => -1
            )));
            $this->set('active_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_active' => 1
                ) ,
                'recursive' => -1
            )));
            $this->set('inactive_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_active' => 0
                ) ,
                'recursive' => -1
            )));
            $this->set('verified_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_verified' => ConstVerification::Verified
                ) ,
                'recursive' => -1
            )));
            $this->set('notverified_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_verified' => NULL
                ) ,
                'recursive' => -1
            )));
            $this->set('waiting_for_verification_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_verified' => ConstVerification::WaitingForVerification
                ) ,
                'recursive' => -1
            )));
            $this->set('waiting_for_approval_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_approved' => 0
                ) ,
                'recursive' => -1
            )));
            $this->set('imported_from_airbnb_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_imported_from_airbnb' => 1
                ) ,
                'recursive' => -1
            )));
            $this->set('pending_count', $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.user_id' => $this->Auth->user('id') ,
                    'Bnbproperty.is_paid' => 0
                ) ,
                'recursive' => -1
            )));
        } else {
        ...
        if (!empty($this->_prefixId) && $is_city) {
            if (isset($this->request->params['named']['type']) && $this->request->params['named']['type'] != 'user') {
                $conditions['Bnbproperty.city_id'] = $this->_prefixId;
            }
        }
        $this->Bnbproperty->recursive = 2;
        $order = array();
        ...
        if (!empty($this->request->params['named']['sortby'])) {
                ...
                $order = array(
                    'Bnbproperty.property_favorite_count'  => 'DESC'
                );
            } elseif ($this->request->params['named']['sortby'] == 'high') {
                $order = array(
                    'Bnbproperty.price_per_night'
                );
            } elseif ($this->request->params['named']['sortby'] == 'low') {
                $order = array(
                    'Bnbproperty.price_per_night' => 'DESC'
                );
                ...
                $order = array(
                    'Bnbproperty.is_featured' => 'DESC'
                );
            } elseif ($this->request->params['named']['sortby'] == 'reviews') {
                $order = array(
                    'Bnbproperty.positive_feedback_count' => 'desc'
                );
            }
        } else {
        ...
        if (isset($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'search') {
            ...
            if (Configure::read('Bnbproperty.days_calculation_mode') == 'Night') {
            ...
            if (!empty($property_list) && count($property_list) > 0) {
                $conditions['Bnbproperty.id'] = $property_list;
            }
            if (!empty($rangefrom)) {
                $conditions['Bnbproperty.price_per_night >='] = $rangefrom;
                $exact_match['Bnbproperty.price_per_night >='] = $rangefrom;
            ...
            if (!empty($search_keyword['named']['latitude']) && !empty($search_keyword['named']['longitude'])) {
                ...
                $fields = "3956 * 2 * ASIN(SQRT(  POWER(SIN((Bnbproperty.latitude - $current_latitude) * pi()/180 / 2), 2) + COS(Bnbproperty.latitude * pi()/180) *  COS($current_latitude * pi()/180) * POWER(SIN((Bnbproperty.longitude - $current_longitude) * pi()/180 / 2), 2)  )) as distance";
            }
            if (!empty($search_keyword['named']['latitude']) && !empty($search_keyword['named']['longitude']) && empty($search_keyword['named']['sw_latitude'])) {
                ...
                if (!isset($conditions['Bnbproperty.city_id'])) {
                    $conditions['Bnbproperty.latitude BETWEEN ? AND ?'] = array(
                        $lat1,
                        $lat2
                    );
                    ...
                    //exact match
                    $exact_match['Bnbproperty.latitude BETWEEN ? AND ?'] = array(
                        $exact_lat1,
                        $exact_lat2
                    );
                    $exact_match['Bnbproperty.longitude BETWEEN ? AND ?'] = array(
                        $exact_lon1,
                        $exact_lon2
                    );
                }
            ...
            if ((isset($this->request->params['named']['is_flexible']) && !$this->request->params['named']['is_flexible']) || (isset($search_keyword['named']['is_flexible']) && !$search_keyword['named']['is_flexible'])) {
                ...
                if ((!empty($this->request->params['named']['latitude']) && !empty($this->request->params['named']['longitude'])) || (!empty($search_keyword['named']['latitude']) && !empty($search_keyword['named']['longitude']))) {
                    $conditions['Bnbproperty.minimum_nights <='] = $days;
                ...
                if (!empty($additional_guest)) {
                    $conditions['AND'][]['OR'] = array(
                        'Bnbproperty.accommodates >=' => $additional_guest,
                        'Bnbproperty.accommodates !=' => 0
                    );
                }
                $booking_conditions['PropertyUser.property_user_status_id'] = array(
                    ConstPropertyUserStatus::Confirmed,
                ...
                if (count($booked_ids) > 0) {
                    $conditions['NOT']['Bnbproperty.id'] = $booked_ids;
                }
            }
            //exact match set
            $exact_match['Bnbproperty.minimum_nights <='] = $days;
            ...
            $exact_ids = $this->Bnbproperty->find('list', array(
            ...
            $this->paginate = array(
                ...
                'fields' => array(
                    'Bnbproperty.id',
                    'Bnbproperty.created',
                    'Bnbproperty.modified',
                    'Bnbproperty.user_id',
                    'Bnbproperty.cancellation_policy_id',
                    'Bnbproperty.property_type_id',
                    'Bnbproperty.room_type_id',
                    'Bnbproperty.bed_type_id',
                    'Bnbproperty.city_id',
                    'Bnbproperty.state_id',
                    'Bnbproperty.title',
                    'Bnbproperty.slug',
                    'Bnbproperty.description',
                    'Bnbproperty.street_view',
                    'Bnbproperty.accommodates',
                    'Bnbproperty.address',
                    'Bnbproperty.unit',
                    'Bnbproperty.phone',
                    'Bnbproperty.price_per_night',
                    'Bnbproperty.price_per_week',
                    'Bnbproperty.price_per_month',
                    'Bnbproperty.minimum_nights',
                    'Bnbproperty.maximum_nights',
                    'Bnbproperty.additional_guest',
                    'Bnbproperty.checkin',
                    'Bnbproperty.checkout',
                    'Bnbproperty.latitude',
                    'Bnbproperty.longitude',
                    'Bnbproperty.zoom_level',
                    'Bnbproperty.rate',
                    'Bnbproperty.bed_rooms',
                    'Bnbproperty.beds',
                    'Bnbproperty.property_view_count',
                    'Bnbproperty.property_favorite_count',
                    'Bnbproperty.property_feedback_count',
                    'Bnbproperty.positive_feedback_count',
                    'Bnbproperty.property_view_count',
                    'Bnbproperty.is_pets',
                    'Bnbproperty.is_negotiable',
                    'Bnbproperty.is_system_flagged',
                    'Bnbproperty.is_active',
                    'Bnbproperty.is_paid',
                    'Bnbproperty.is_featured',
                    'Bnbproperty.is_verified',
                    '((Bnbproperty.positive_feedback_count/Bnbproperty.property_feedback_count)*100) as reviews',
                    $fields,
                ) ,
                'order' => $order,
                'limit' => $limit,
            ...
            if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] != 'collection') {
                $conditions['Bnbproperty.beds >='] = 1;
                $conditions['Bnbproperty.bed_rooms >='] = 1;
                $conditions['Bnbproperty.bath_rooms >='] = 1;
            }
            $this->paginate = array(
                'conditions' => array(
                    $conditions
            ...
            $this->set('booked_property_ids', $booked_ids);
            $this->set('exact_ids', $exact_ids);
            $this->request->data['Bnbproperty']['is_flexible'] = 1;
        }
        $total_property_count = $this->Bnbproperty->find('count', array(
            'conditions' => $conditions,
            'recursive' => 0
        ));
        $this->set('total_result', $total_property_count);
        $set_filter_count = $this->Bnbproperty->getFilterCount($conditions);
        $this->set('search_keyword', $search_keyword);
        $roomTypes = $this->Bnbproperty->RoomType->find('list', array(
            'order' => array(
                'RoomType.name' => 'asc'
            )
        ));
        $conditions['Bnbproperty.room_type_id'] = array_keys($roomTypes);
        $room_types = $this->Bnbproperty->find('all', array(
            'fields' => array(
                'Bnbproperty.room_type_id',
                'count(Bnbproperty.id) as property_count',
            ) ,
            'conditions' => $conditions,
            'group' => 'Bnbproperty.room_type_id',
            'recursive' => -1
        ));
        $rom_types = array();
        ...
        $holidayTypes = $this->Bnbproperty->HolidayType->find('list', array(
            'order' => array(
        ...
        $language_lists = $this->Bnbproperty->find('list', array(
            'conditions' => array(
                'Bnbproperty.language_id !=' => 0
            ) ,
            'fields' => array(
                'Bnbproperty.language_id'
            )
        ));
        $languages = $this->Bnbproperty->User->UserProfile->Language->find('list', array(
            'conditions' => array(
        ...
        $amenities = $this->Bnbproperty->Amenity->find('list', array(
            'order' => array(
                'Amenity.name' => 'asc'
            )
        ));
        ...
        $propertyTypes = $this->Bnbproperty->PropertyType->find('list', array(
            'order' => array(
                'PropertyType.name' => 'asc'
            )
        ));
        $conditions['Bnbproperty.property_type_id'] = array_keys($propertyTypes);
        $property_types = $this->Bnbproperty->find('all', array(
            'fields' => array(
                'Bnbproperty.property_type_id',
                'count(Bnbproperty.id) as property_count',
            ) ,
            'conditions' => $conditions,
            'group' => 'Bnbproperty.property_type_id',
            'recursive' => -1
        ));
        ...
        if (!Configure::read('Bnbproperty.is_enable_property_count')) {
            $is_searching = true;
        }
        ...
        if ($this->RequestHandler->prefers('json') && $is_searching === true) {
            ...
            for ($i = 0; $i < $total_properties; $i++) {
                ...
                $this->Bnbproperty->saveiPhoneAppThumb($properties[$i]['Attachment']);
                $image_options = array(
        ...
        if (!isset($search_keyword['named']['range_to'])) {
            $this->request->data['Bnbproperty']['range_to'] = '301';
        } else {
            $this->request->data['Bnbproperty']['range_to'] = $search_keyword['named']['range_to'];
        }
        if (isset($search_keyword['named']['range_from'])) {
            $this->request->data['Bnbproperty']['range_from'] = $search_keyword['named']['range_from'];
        }
        if (!empty($search_keyword['named']['is_flexible'])) {
            $this->request->data['Bnbproperty']['is_flexible'] = $search_keyword['named']['is_flexible'];
        }
        if (!isset($search_keyword['named']['deposit_to'])) {
            $this->request->data['Bnbproperty']['deposit_to'] = '301';
        } else {
            $this->request->data['Bnbproperty']['deposit_to'] = $search_keyword['named']['deposit_to'];
        }
        if (isset($search_keyword['named']['deposit_from'])) {
            $this->request->data['Bnbproperty']['deposit_from'] = $search_keyword['named']['deposit_from'];
        }
        if (!empty($search_keyword['named']['is_flexible'])) {
            $this->request->data['Bnbproperty']['is_flexible'] = $search_keyword['named']['is_flexible'];
        }
        if (!empty($search_keyword['named']['additional_guest'])) {
            $this->request->data['Bnbproperty']['additional_guest'] = $search_keyword['named']['additional_guest'];
        }
        if (isset($search_keyword['named']['checkin'])) {
            $this->request->data['Bnbproperty']['checkin'] = $search_keyword['named']['checkin'];
        }
        if (isset($search_keyword['named']['checkout'])) {
            $this->request->data['Bnbproperty']['checkout'] = $search_keyword['named']['checkout'];
        }
        if (!empty($this->request->params['named']['request_id'])) {
            $this->request->data['Bnbproperty']['request_id'] = $this->request->params['named']['request_id'];
        }
        //checkin/checkout date valid check
        if ($this->request->data['Bnbproperty']['checkin'] < date('Y-m-d') || $this->request->data['Bnbproperty']['checkin'] > $this->request->data['Bnbproperty']['checkout'] || $this->request->data['Bnbproperty']['checkout'] < date('Y-m-d')) {
        ...
        if ($this->Auth->user('id') && $this->Auth->user('is_show_facebook_friends') && $this->Auth->user('is_facebook_friends_fetched')) {
            $social_conditions['Bnbproperty.user_id != '] = $this->Auth->user('id');
            $social_conditions = array_merge($conditions, $social_conditions);
            $tmpProperties = $this->Bnbproperty->find('list', array(
            ...
            if (!empty($tmpProperties)) {
                $user_ids = $this->Bnbproperty->User->find('list', array(
                    'conditions' => array(
                ...
                if (!empty($user_ids)) {
                    $network_level = $this->Bnbproperty->getFacebookFriendLevel($user_ids);
        ...
        if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'collection') {
            ...
            if (!empty($properties)) {
                foreach($properties as $property) {
                    $collections = $this->Bnbproperty->CollectionsProperty->find('first', array(
                        'conditions' => array(
                            'CollectionsBnbproperty.property_id = ' => $property['Property']['id'],
                            'CollectionsBnbproperty.collection_id = ' => $collection['Collection']['id']
                        ) ,
                        'fields' => array(
                            'CollectionsBnbproperty.display_order',
                        ) ,
                        'recursive' => -1,
                    ));
        ...
        if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'myproperties') {
            $chart_data = $this->Bnbproperty->getBookingChart($this->Auth->user('id') , null);
            $moreActions = $this->Bnbproperty->moreMyPropertiesActions;
    ...
    public function calendar_edit()
    {
        ...
        $property_status_list = $this->Bnbproperty->PropertyUser->PropertyUserStatus->find('list', array(
            'conditions' => array(
    ...
    public function calendar($type)
    {
        ...
        $conditions = array();
        if (!empty($id)) {
            $conditions['Bnbproperty.id'] = explode(',', $id);
        } else {
            if (!$this->Auth->user()) {
                throw new NotFoundException(__l('Invalid request'));
            }
        ...
        if (!empty($type) && $type == 'guest') {
            ...
            $data = $this->Bnbproperty->_getCalendarBookingDates($id, $month, $year);
            ...
            for ($i = 0; $i < 12; $i++) {
                ...
                $guest_lists[$i]['id'] = $id;
                $guest_lists[$i]['data'] = $this->Bnbproperty->_getCalendarBookingDates($id, $month, $year);
                if ($month == 12) {
                    $month = 1;
                    $year = $year+1;
                } else {
    ...
    public function get_info($id)
    {
        ...
        $property = $this->Bnbproperty->find('first', array(
            'conditions' => array(
                'Bnbproperty.id =' => $id
            ) ,
            'contain' => array(
    ...
    public function view($slug = null, $hash = null, $salt = null)
    {
        ...
        if (!empty($hash) && !empty($salt)) {
            ...
            $named_array = $this->Bnbproperty->getSearchKeywords($hash, $salt);
        ...
        $amenities = $this->Bnbproperty->Amenity->find('list');
        $holidayTypes = $this->Bnbproperty->HolidayType->find('list');
        ...
        if (isset($this->request->params['named']['order_id'])) {
            $propertyUser = $this->Bnbproperty->PropertyUser->find('first', array(
                'conditions' => array(
        ...
        $this->request->data['PropertyView']['ip_id'] = $this->Bnbproperty->PropertyView->toSaveIp();
        $this->Bnbproperty->PropertyView->create();
        $this->Bnbproperty->PropertyView->save($this->request->data);
        $this->pageTitle.= ' - ' . $property['Property']['title'];
        $amenities_list = $this->Bnbproperty->Amenity->find('list', array(
            'order' => array(
                'Amenity.name' => 'ASC'
            )
        ));
        $holiday_list = $this->Bnbproperty->HolidayType->find('list', array(
            'order' => array(
                'HolidayType.name' => 'ASC'
            )
        ));
        ...
        if ($this->Auth->user('id') && $this->Auth->user('is_show_facebook_friends') && $this->Auth->user('is_facebook_friends_fetched')) {
            $social_conditions['Bnbproperty.user_id != '] = $this->Auth->user('id');
            $host_user_id = $this->Bnbproperty->User->find('list', array(
                'conditions' => array(
            ...
            if (!empty($host_user_id)) {
                $network_level = $this->Bnbproperty->getFacebookFriendLevel($host_user_id);
                $this->set('network_level', $network_level);
                $userFacebookFriends = $this->Bnbproperty->getMutualFriends($this->Auth->user('id') , $property['Property']['user_id']);
        ...
        if ($this->RequestHandler->prefers('json')) {
            $this->view = 'Json';
            $this->Bnbproperty->saveiPhoneAppThumb($property['Attachment']);
            $image_options = array(
                'dimension' => 'iphone_big_thumb',
                'class' => '',
                'alt' => $property['Property']['title'],
        ...
        $chart_data = $this->Bnbproperty->getBookingChart(null, $property['Property']['id']);
...
debug($this->request->data);
        ...
        $this->Bnbproperty->Behaviors->attach('ImageUpload', Configure::read('image.file'));
        $this->set('is_paypal_enabled', $this->Bnbproperty->isPaymentGatewayEnabled(ConstPaymentGateways::PayPal));
        if (!empty($this->request->data['Bnbproperty']['step1'])) {
            $this->Bnbproperty->set($this->request->data);
            if ($this->Bnbproperty->validates($this->request->data)) {
                $this->set('steps', 2);
                $user_id = !empty($this->request->data['Bnbproperty']['user_id']) ? $this->request->data['Bnbproperty']['user_id'] : $this->Auth->user('id');
                $userProfile = $this->Bnbproperty->User->UserProfile->find('first', array(
                    'conditions' => array(
        ...
        } else if (!empty($this->request->data['Bnbproperty']['step2'])) {
            $paypal_account = 1;
            if (!empty($this->request->data['UserProfile']['paypal_account'])) {
                ...
                if (strtoupper($rsPayStatus['responseEnvelope.ack']) != 'SUCCESS' || strtoupper($rsPayStatus['accountStatus']) != 'VERIFIED') {
                    $paypal_account = 0;
                    $this->Bnbproperty->User->UserProfile->validationErrors['paypal_account'] = __l('Enter PayPal verification email and name associated with your PayPal');
                }
            }
            $this->Bnbproperty->set($this->request->data);
            if ($paypal_account&$this->Bnbproperty->validates($this->request->data)) {
                $this->request->data['Bnbproperty']['checkin'] = array(
                    'hour' => '6',
                    'minute' => '00',
                    'meridien' => 'am'
                );
                $this->request->data['Bnbproperty']['checkout'] = array(
                    'hour' => '9',
                    'minute' => '00',
                    'meridien' => 'am'
                );
        ...
        } else if (!empty($this->request->data['Bnbproperty']['step3'])) {
            $this->Bnbproperty->set($this->request->data);
            if ($this->Bnbproperty->validates($this->request->data)) {
                $user_profile = $this->Bnbproperty->User->UserProfile->find('first', array(
                    'conditions' => array(
                ...
                $this->request->data['Bnbproperty']['phone'] = $user_profile['UserProfile']['phone'];
                $this->request->data['Bnbproperty']['backup_phone'] = $user_profile['UserProfile']['backup_phone'];
                $this->set('steps', 4);
            } else {
                $this->Session->setFlash(__l('Property could not be added. Please, try again') , 'default', null, 'error');
                $this->set('steps', 3);
            }
        } else if (!empty($this->request->data['Bnbproperty']['step4'])) {
            $this->Bnbproperty->set($this->request->data);
            if ($this->Bnbproperty->validates($this->request->data)) {
                $this->set('steps', 5);
            } else {
        ...
        } else if (!empty($this->request->data['Bnbproperty']['step5'])) {
            $this->Bnbproperty->set($this->request->data);
            if ($this->Bnbproperty->validates($this->request->data)) {
                $this->request->data['Bnbproperty']['user_id'] = !empty($this->request->data['Bnbproperty']['user_id']) ? $this->request->data['Bnbproperty']['user_id'] : $this->Auth->user('id');
                $this->request->data['Bnbproperty']['is_active'] = 0;
                $this->request->data['Bnbproperty']['ip_id'] = $this->Bnbproperty->toSaveIp();
                if (empty($this->request->data['Bnbproperty']['maximum_nights'])) {
                    $this->request->data['Bnbproperty']['maximum_nights'] = 0;
                }
                //state and country looking
                if (!empty($this->request->data['City']['name'])) {
                    $this->request->data['Bnbproperty']['city_id'] = !empty($this->request->data['City']['id']) ? $this->request->data['City']['id'] : $this->Bnbproperty->City->findOrSaveAndGetId($this->request->data['City']['name']);
                }
                if (!empty($this->request->data['Bnbproperty']['country_id'])) {
                    $this->request->data['Bnbproperty']['country_id'] = $this->Bnbproperty->Country->findCountryId($this->request->data['Bnbproperty']['country_id']);
                }
                if (!empty($this->request->data['State']['name'])) {
                    $this->request->data['Bnbproperty']['state_id'] = !empty($this->request->data['State']['id']) ? $this->request->data['State']['id'] : $this->Bnbproperty->State->findOrSaveAndGetId($this->request->data['State']['name']);
                }
                $this->Bnbproperty->create();
                $this->Bnbproperty->set($this->request->data);
                ...
                if ($uploaded_photo_count&$this->Bnbproperty->validates($this->request->data)) {
                    if (!Configure::read('Bnbproperty.listing_fee')) {
                        $this->request->data['Bnbproperty']['is_paid'] = 1;
                        $this->request->data['Bnbproperty']['is_active'] = 1;
                        $this->request->data['Bnbproperty']['is_approved'] = (Configure::read('Bnbproperty.is_auto_approve')) ? 1 : 0;
                    }
                    ...
                    if (!empty($userProfile['UserProfile']['language_id'])) {
                        $this->request->data['Bnbproperty']['language_id'] = $userProfile['UserProfile']['language_id'];
                    }
                    $this->Bnbproperty->save($this->request->data);
                    $property_id = $this->Bnbproperty->getLastInsertId();
                    if (!empty($this->request->data['UserProfile']['paypal_account'])) {
                        if (empty($this->request->data['UserProfile']['id'])) {
                            $userProfile = $this->Bnbproperty->User->UserProfile->find('first', array(
                                'conditions' => array(
                                    'UserProfile.user_id' => $this->request->data['Bnbproperty']['user_id']
                                ) ,
                                'recursive' => -1
                            ));
							...
							if(!empty($userProfile)){
								...
								$this->Bnbproperty->User->UserProfile->create();
								...
								$_data['user_id'] = $this->request->data['Bnbproperty']['user_id'];						
							}
                        }
						$this->Bnbproperty->User->UserProfile->set($_data);
                        $this->Bnbproperty->User->UserProfile->save($_data);
                    }
                    // saving in to request property
                    if (!empty($this->request->data['Bnbproperty']['request_id'])) {
                        $this->Bnbproperty->PropertiesRequest->create();
                        $request = array();
                        $request['PropertiesRequest']['request_id'] = $this->request->data['Bnbproperty']['request_id'];
                        $request['PropertiesRequest']['property_id'] = $property_id;
                        $request['PropertiesRequest']['is_active'] = 1;
                        $this->Bnbproperty->PropertiesRequest->set($request);
                        $this->Bnbproperty->PropertiesRequest->save($request);
                        $this->Bnbproperty->__updatePropertyRequest($this->request->data['Bnbproperty']['request_id'], $property_id);
                    }
                    $this->Bnbproperty->Attachment->create();
                    // save attachment
                    ...
                    if (empty($_FILES)) { // Flash Upload
                        for ($i = 0; $i < count($this->request->data['Attachment']); $i++) {
                            if (!empty($this->request->data['Attachment'][$i]['filename'])) {
                                ...
                                $this->Bnbproperty->Attachment->Behaviors->attach('ImageUpload');
                                $this->Bnbproperty->Attachment->enableUpload(false); //don't trigger upload behavior on save
                                ...
                                fclose($fp);
                                $this->Bnbproperty->Attachment->create();
                                $this->Bnbproperty->Attachment->save($attachment);
                                $this->Bnbproperty->Attachment->Behaviors->detach('ImageUpload');
                                unset($_SESSION["property_file_info"][$file_id]);
                            }
                        }
                        if (Configure::read('Bnbproperty.listing_fee') && $this->Auth->user('user_type_id') != ConstUserTypes::Admin) {
                            ...
                            $property = $this->Bnbproperty->find('first', array(
                                'conditions' => array(
                                    'Bnbproperty.id = ' => $this->Bnbproperty->id,
                                ) ,
                                'fields' => array(
                                    'Bnbproperty.id',
                                    'Bnbproperty.title',
                                    'Bnbproperty.slug',
                                    'Bnbproperty.admin_suspend',
                                ) ,
                                'recursive' => -1,
                            ));
                            ...
                            if (!empty($mail_template)) {
                                ...
                                if (Configure::read('messages.is_send_internal_message')) {
                                    $message_id = $this->Bnbproperty->Message->sendNotifications($this->Auth->user('id') , $subject, $message, 0, $is_review = 0, $property['Property']['id'], 0);
                            ...
                            if ($property['Property']['admin_suspend']) {
                                ...
                                if (Configure::read('Bnbproperty.is_auto_approve')) {
                        ...
                        for ($i = 0; $i < count($this->request->data['Attachment']); $i++) {
                            if (!empty($this->request->data['Attachment'][$i]['filename']['tmp_name'])) {
                                ...
                                $this->Bnbproperty->Attachment->Behaviors->attach('ImageUpload', Configure::read('Bnbproperty.file'));
                                $this->Bnbproperty->Attachment->set($this->request->data);
                                if (!$this->Bnbproperty->validates() |!$this->Bnbproperty->Attachment->validates()) {
                                    $attachmentValidationError[$i] = $this->Bnbproperty->Attachment->validationErrors;
                                    $is_form_valid = false;
                        ...
                        if (!$upload_photo_count) {
                            $this->Bnbproperty->validates();
                            $this->Bnbproperty->Attachment->validationErrors[0]['filename'] = __l('Required');
                            $is_form_valid = false;
                        }
                        if (!empty($attachmentValidationError)) {
                            foreach($attachmentValidationError as $key => $error) {
                                $this->Bnbproperty->Attachment->validationErrors[$key]['filename'] = $error;
                            }
                        }
                        if ($is_form_valid) {
        ...
        } else if (!empty($this->request->data['Bnbproperty']['back_step_1'])) {
            $this->set('steps', 1);
        } else if (!empty($this->request->data['Bnbproperty']['back_step_2'])) {
            $this->set('steps', 2);
        } else if (!empty($this->request->data['Bnbproperty']['back_step_3'])) {
            $this->set('steps', 3);
        } else if (!empty($this->request->data['Bnbproperty']['back_step_4'])) {
            $this->set('steps', 4);
        } else {
            $this->set('steps', 1);
        }
        $currency_code = Configure::read('site.currency_code');
        $collections = $this->Bnbproperty->Collection->find('list', array(
            'order' => array(
                'Collection.title' => 'ASC'
            )
        ));
        $users = $this->Bnbproperty->User->find('list');
        $tmpCancellationPolicies = $this->Bnbproperty->CancellationPolicy->find('all', array(
            'conditions' => array(
        ...
        $bedTypes = $this->Bnbproperty->BedType->find('list', array(
            'conditions' => array(
                'BedType.is_active' => 1
            ) ,
            'order' => array(
        ...
        $cities = $this->Bnbproperty->City->find('list', array(
			'conditions' => array(
                'City.is_approved' => 1
            ) ,
            'order' => array(
        ...
        $states = $this->Bnbproperty->State->find('list', array(
			'conditions' => array(
                'State.is_approved' => 1
            ) ,
            'order' => array(
        ...
        $countries = $this->Bnbproperty->Country->find('list', array(
            'fields' => array(
                'Country.iso2',
                'Country.name'
            ) ,
        ...
        $moreStreetActions = $this->Bnbproperty->moreStreetActions;
        $moreMeasureActions = $this->Bnbproperty->moreMeasureActions;
        ...
        if (!empty($request) && !empty($request_id)) {
            $this->request->data['Bnbproperty']['request_id'] = $request_id;
            $request = $this->Bnbproperty->PropertiesRequest->Request->find('first', array(
                'conditions' => array(
                    'Request.id' => $this->request->data['Bnbproperty']['request_id'],
            ...
            $this->request->data['Bnbproperty']['request_latitude'] = $request['Request']['latitude'];
            $this->request->data['Bnbproperty']['request_longitude'] = $request['Request']['longitude'];
    ...
    */
    function update_social_networking($property_id = null)
    {
        ...
        if (!$property['Property']['is_system_flagged'] && !empty($property['Property']['is_active'])) {
            ...
            if (Configure::read('social_networking.post_property_on_user_facebook')) {
                if ($user['User']['fb_user_id'] > 0) {
					...
					$property['Property']['fb_user_id'] = $user['User']['fb_user_id'];
					$property['Property']['fb_access_token'] = $user['User']['fb_access_token'];
            ...
            if (Configure::read('Bnbproperty.post_property_on_facebook')) { // post on site facebook
                $fb_message = $user['User']['username'] . ' ' . __l('listed a new property "') . '' . $property['Property']['title'] . __l('" in ') . Configure::read('site.name');
                $getFBReturn = $this->postOnFacebook($property, $fb_message, 1);
            }
            if (Configure::read('Bnbproperty.post_property_on_twitter')) { // post on site twitter
                $message = $user['User']['username'] . ' ' . __l('listed a new property "') . '' . $property['Property']['title'] . __l('" in ') . Configure::read('site.name');
                $message.= ' ' . $url;
    ...
    public function edit($id = null)
    {
        ...
        if (!empty($this->request->data)) {			
            ...
            if ($uploaded_photo_count&$this->Bnbproperty->validates($this->request->data)) {
                if ($this->Bnbproperty->save($this->request->data)) {
                    $property_id = $this->request->data['Bnbproperty']['id'];
                    $this->Bnbproperty->Attachment->create();
                    // save attachment
                    $attachment['Attachment']['foreign_id'] = $property_id;
                    $attachment['Attachment']['class'] = 'Property';
                    if (empty($_FILES)) { // Flash Upload
                        for ($i = 0; $i < count($this->request->data['Attachment']); $i++) {
                            ...
                            if (!empty($this->request->data['Attachment'][$i]['checked_id']) && !empty($this->request->data['Attachment'][$i]['id'])) {
                                $this->Bnbproperty->Attachment->delete($this->request->data['Attachment'][$i]['id']);
                                $upload_photo = 1;
                            }
                            if (!empty($this->request->data['Attachment'][$i]['filename'])) {
                                $file_id = $this->request->data['Attachment'][$i]['filename'];
                                ...
                                $this->Bnbproperty->Attachment->save($_attachment);
                            }
                        }
            ...
            $this->request->data = $this->Bnbproperty->read(null, $id);
            if (empty($this->request->data)) {
                throw new NotFoundException(__l('Invalid request'));
            }
        }
        $this->pageTitle.= ' - ' . $this->request->data['Bnbproperty']['title'];
        $collections = $this->Bnbproperty->Collection->find('list', array(
            'order' => array(
                'Collection.title' => 'ASC'
            )
        ...
        $minNights = array();
        $maxNights = array();
        for ($i = 1; $i <= Configure::read('Bnbproperty.minimum_nights'); $i++) {
            $minNights[$i] = $i;
        }
        for ($i = 1; $i <= Configure::read('Bnbproperty.maximum_nights'); $i++) {
            $maxNights[$i] = $i;
        }
        $this->set('minNights', $minNights);
        $this->set('maxNights', $maxNights);
    ...
    public function update_view_count()
    {
        if (!empty($_POST['ids'])) {
            ...
            $properties = $this->Bnbproperty->find('all', array(
                'conditions' => array(
                    'Bnbproperty.id' => $ids
                ) ,
                'fields' => array(
    ...
    function admin_manage_collections()
    {
        ...
        if (isset($this->request->data)) {
            ...
            unset($properties_data['Bnbproperty']['r']);
            unset($properties_data['Bnbproperty']['more_action_id']);
            $property_list = array();
            foreach($properties_data['Bnbproperty'] as $key => $property) {
                if ($property['id'] == 1) {
                    $property_list[] = $key;
                }
            }
    ...
    public function admin_index()
    {
        ...
        $this->pageTitle = __l('Properties');
        $this->set('active_properties', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_active = ' => 1,
                'Bnbproperty.admin_suspend = ' => 0,
            ) ,
            'recursive' => -1
        )));
        $this->set('inactive_properties', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_active' => 0
            ) ,
            'recursive' => -1
        )));
        $this->set('suspended_properties', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.admin_suspend = ' => 1,
            ) ,
            'recursive' => -1
        )));
        $this->set('system_flagged', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_system_flagged = ' => 1,
                'Bnbproperty.admin_suspend = ' => 0,
            ) ,
            'recursive' => -1
        )));
        $this->set('user_flagged', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_user_flagged = ' => 1,
                'Bnbproperty.admin_suspend = ' => 0,
            ) ,
            'recursive' => -1
        )));
        $this->set('featured', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_featured = ' => 1
            ) ,
            'recursive' => -1
        )));
        $this->set('home', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_show_in_home_page = ' => 1
            ) ,
            'recursive' => -1
        )));
        $this->set('verified', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_verified' => ConstVerification::Verified
            ) ,
            'recursive' => -1
        )));
        $this->set('waiting_for_verification', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_verified' => ConstVerification::WaitingForVerification
            ) ,
            'recursive' => -1
        )));
        $this->set('waiting_for_approval', $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_approved' => 0
            ) ,
            'recursive' => -1
        ...
        $this->set('total_properties', $this->Bnbproperty->find('count', array(
            'recursive' => -1
        )));
        if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'user-flag') {
            $conditions['Bnbproperty.is_user_flagged'] = 1;
			$conditions['Bnbproperty.admin_suspend'] = 0;
            $this->pageTitle.= __l(' - User Flagged');
        }
        if (isset($this->request->params['named']['stat']) && $this->request->params['named']['stat'] == 'day') {
            $conditions['TO_DAYS(NOW()) - TO_DAYS(Bnbproperty.created) <= '] = 0;
            $this->pageTitle.= __l(' - today');
        }
        if (isset($this->request->params['named']['stat']) && $this->request->params['named']['stat'] == 'week') {
            $conditions['TO_DAYS(NOW()) - TO_DAYS(Bnbproperty.created) <= '] = 7;
            $this->pageTitle.= __l(' - in this week');
        }
        if (isset($this->request->params['named']['stat']) && $this->request->params['named']['stat'] == 'month') {
            $conditions['TO_DAYS(NOW()) - TO_DAYS(Bnbproperty.created) <= '] = 30;
            $this->pageTitle.= __l(' - in this month');
        }
        if (isset($this->request->params['named']['property_type_id'])) {
            $this->request->data['Bnbproperty']['property_type_id'] = $this->request->params['named']['property_type_id'];
            $conditions['Bnbproperty.property_type_id'] = $this->request->params['named']['property_type_id'];
            // Get the Property Category name
            $category_name = $this->Bnbproperty->PropertyType->find('first', array(
                'conditions' => array(
        ...
        if (isset($this->request->params['named']['q'])) {
            $conditions[] = array(
                'OR' => array(
                    array(
                        'Bnbproperty.title LIKE ' => '%' . $this->request->params['named']['q'] . '%'
                    ) ,
                    array(
                        'User.username LIKE ' => '%' . $this->request->params['named']['q'] . '%'
                    ) ,
                    array(
                        'Bnbproperty.description LIKE ' => '%' . $this->request->params['named']['q'] . '%'
                    )
                )
            );
            $this->request->data['Bnbproperty']['q'] = $this->request->params['named']['q'];
        }
        // check the filer passed through named parameter
        if (isset($this->request->params['named']['filter_id'])) {
            $this->request->data['Bnbproperty']['filter_id'] = $this->request->params['named']['filter_id'];
        }
        if (!empty($this->request->data['Bnbproperty']['filter_id'])) {
            if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Approved) {
                $conditions['Bnbproperty.is_approved'] = 1;
                $this->pageTitle.= __l(' - Approved ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Disapproved) {
                $conditions['Bnbproperty.is_approved'] = 0;
                $this->pageTitle.= __l(' - Waiting for Approval ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Active) {
                $conditions['Bnbproperty.is_active'] = 1;
                $conditions['Bnbproperty.admin_suspend'] = 0;
                $this->pageTitle.= __l(' - Enabled ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Inactive) {
                $conditions['Bnbproperty.is_active'] = 0;
                $this->pageTitle.= __l(' - Disabled ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Suspend) {
                $conditions['Bnbproperty.admin_suspend'] = 1;
                $this->pageTitle.= __l(' - Suspended ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Flagged) {
                $conditions['Bnbproperty.is_system_flagged'] = 1;
                $conditions['Bnbproperty.admin_suspend'] = 0;
                $this->pageTitle.= __l(' - Flagged ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::UserFlagged) {
                $conditions['Bnbproperty.property_flag_count !='] = 0;
                $conditions['Bnbproperty.admin_suspend'] = 0;
                $this->pageTitle.= __l(' - User Flagged ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Featured) {
                $conditions['Bnbproperty.is_featured'] = 1;
                $this->pageTitle.= __l(' - Featured ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::HomePage) {
                $conditions['Bnbproperty.is_show_in_home_page'] = 1;
                $this->pageTitle.= __l(' - HomePage ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Verified) {
                $conditions['Bnbproperty.is_verified'] = ConstVerification::Verified;
                $this->pageTitle.= __l(' - Verified ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::WaitingForVerification) {
                $conditions['Bnbproperty.is_verified'] = ConstVerification::WaitingForVerification;
                $this->pageTitle.= __l(' - Waiting for Verification ');
            } else if ($this->request->data['Bnbproperty']['filter_id'] == ConstMoreAction::Imported) {
                $conditions['Bnbproperty.is_imported_from_airbnb'] = 1;
        ...
        if (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'listing_fee') {
            ...
            $conditions['Bnbproperty.is_verified'] = 1;
            $this->pageTitle.= __l(' - Verified ');
        }
        $this->Bnbproperty->recursive = 1;
        $this->paginate = array(
            'conditions' => array(
                $conditions
            ) ,
        ...
        $property_types = $this->Bnbproperty->PropertyType->find('list', array(
            'conditions' => array(
                'PropertyType.is_active' => 1
            ) ,
            'recursive' => -1
        ...
        $moreActions = $this->Bnbproperty->moreActionpropertys;
        $users = $this->Bnbproperty->User->find('list');
    ...
    public function cluster_data()
    {
        ...
        $conditions['Bnbproperty.is_approved'] = 1;
        $conditions['Bnbproperty.admin_suspend'] = 0;
        $property_count = $this->Bnbproperty->find('count', array(
            'conditions' => $conditions,
            'recursive' => -1,
        ));
        $results['Properties'] = $this->Bnbproperty->find('all', array(
            'conditions' => $conditions,
            'fields' => array(
                'Bnbproperty.id',
                'Bnbproperty.latitude',
    ...
    public function property_calendar($year = null, $month = null, $property_id)
    {
        ...
        $this->set('month', $month);
        $conditions = array();
        $conditions['Bnbproperty.id'] = $property_id;
        $data = $this->Bnbproperty->getCalendarData($year, $monthInNumber, $property_id);
        $this->set('data', $data);
    }
    public function manage_property()
    {
        $r = $this->request->data['Bnbproperty']['r'];
        if (!empty($this->request->data['Bnbproperty']['request_id']) && !empty($this->request->data['Bnbproperty']['property'])) {
            if ($request_property_id = $this->Bnbproperty->__updatePropertyRequest($this->request->data['Bnbproperty']['request_id'], $this->request->data['Bnbproperty']['property'])) {
                ...
                $property = $this->Bnbproperty->find('first', array(
                    'conditions' => array(
                        'Bnbproperty.id' => $this->request->data['Bnbproperty']['property'],
                    ) ,
                    'recursive' => -1
                ));
				$_data = array();
				...
				$_data['PropertyUser']['property_id'] = $this->request->data['Bnbproperty']['property'];
				...
				$_data['PropertyUser']['price'] = $this->Bnbproperty->checkCustomPrice($request['Request']['checkin'], getCheckoutDate($request['Request']['checkout']) , $this->request->data['Bnbproperty']['property'], $request['Request']['accommodates']);
				$_data['PropertyUser']['guests'] = $request['Request']['accommodates'];
				$_data['PropertyUser']['original_price'] = $_data['PropertyUser']['price'];
				$_data['PropertyUser']['traveler_service_amount'] = ($_data['PropertyUser']['price']) *(Configure::read('Bnbproperty.booking_service_fee') /100);
				$hosting_fee = ($_data['PropertyUser']['price']) *(Configure::read('Bnbproperty.host_commission_amount') /100);
				...
				$this->Bnbproperty->PropertyUser->save($_data, false);
				$order_id = $this->Bnbproperty->PropertyUser->getLastInsertId();
				$this->Bnbproperty->PropertiesRequest->updateAll(array(
				...
				$message_id = $this->Bnbproperty->PropertyUser->Message->sendNotifications($this->Auth->user('id') , $subject, $message, $order_id, $is_review = 0, $this->request->data['Bnbproperty']['property'], ConstPropertyUserStatus::RequestNegotiation);
				$this->redirect(array(
					'controller' => 'messages',
					'action' => 'activities',
					'order_id' => $order_id,
    ...
    public function home()
    {
        ...
        $properties = $this->Bnbproperty->find('all', array(
            'conditions' => array(
                'Bnbproperty.is_active' => 1,
                'Bnbproperty.is_show_in_home_page' => 1,
                'Bnbproperty.is_paid' => 1,
                'Bnbproperty.is_approved' => 1,
				'Bnbproperty.admin_suspend' => 0,
            ) ,
            'contain' => array(
                'User',
    ...
    public function update_price()
    {
        ...
        switch ($_POST['type']) {
            case 'night':
                $price = $this->Bnbproperty->checkCustomPrice($_POST['checkin'], $_POST['checkout'], $_POST['property_id'], $_POST['guest'], true);
                break;

            case 'week':
                $price = $this->Bnbproperty->checkCustomWeekPrice($_POST['checkin'], $_POST['checkout'], $_POST['property_id'], $_POST['guest'], true);
                break;

            case 'month':
                $price = $this->Bnbproperty->checkCustomMonthPrice($_POST['checkin'], $_POST['checkout'], $_POST['property_id'], $_POST['guest'], true);
                break;
        }
        echo $price;
        exit;
    ...
    public function import()
    {
        ...
        $importedProperties = $this->Bnbproperty->find('list', array(
            'conditions' => array(
                'Bnbproperty.is_imported_from_airbnb' => 1,
                'Bnbproperty.user_id' => $this->Auth->user('id') ,
            ) ,
            'fields' => array(
                'Bnbproperty.id',
                'Bnbproperty.airbnb_property_id',
            )
        ));
        $this->set('importedProperties', $importedProperties);
        if (!empty($this->request->data['Bnbproperty']['step2'])) {
            $this->Bnbproperty->set($this->request->data);
            if ($this->Bnbproperty->validates($this->request->data)) {
                ...
                if (!empty($return['error']) || !empty($return['success'])) {
                    if (!empty($return['error'])) {
                        foreach($return['ids'] as $id) {
                            $title[] = '"' . $this->request->data['Bnbproperty'][$id]['title'] . '"';
                        }
                        $title = implode(', ', $title);
        ...
        } elseif (!empty($this->request->data['Bnbproperty']['step1'])) {
            $this->Bnbproperty->set($this->request->data);
            if ($this->Bnbproperty->validates($this->request->data)) {
                $this->set('properties', $this->Airbnb->import($this->request->data, 1, $importedProperties));
                $this->set('steps', 2);
    ...
    public function post_to_craigslist()
    {
        ...
        if (!empty($this->request->params['named']['property_id'])) {
            ...
            $property_id = $this->request->data['Bnbproperty']['property_id'];
        }
        ...
        if (!empty($this->request->data)) {
            $this->Bnbproperty->set($this->request->data);
            if ($this->Bnbproperty->validates($this->request->data)) {
                $this->request->data['Bnbproperty']['price_per_night'] = $property['Property']['price_per_night'];
                $this->request->data['Bnbproperty']['email'] = $property['User']['email'];
                $this->request->data['Bnbproperty']['city'] = $property['City']['name'];
                $this->request->data['Bnbproperty']['state'] = $property['State']['name'];
                $this->request->data['Bnbproperty']['description'] = $description;
        ...
        $this->request->data['Bnbproperty']['property_id'] = $property_id;
        if (!isset($this->request->data['Bnbproperty']['title'])) {
            $this->request->data['Bnbproperty']['title'] = $property['Property']['title'];
        }
    ...
    public function sample_data()
    {
        ...
        $dummyData = $this->Bnbproperty->query('SELECT * FROM tmp_dummy_data');
        $title = array(
            'Beach house in ',
            'Rooms for rent in ',
        ...
        foreach($dummyData as $dummy) {
            ...
            $tmp_country = $this->Bnbproperty->query('SELECT * FROM tmp_countries WHERE id = ' . $country_arr[$country]);
            $escape_not_in_city = '';
            if (!empty($escape_city)) {
                $escape_not_in_city = ' AND id NOT IN (' . implode(',', $escape_city) . ')';
            }
            $tmp_city = $this->Bnbproperty->query('SELECT * FROM tmp_cities WHERE country_id = ' . $country_arr[$country] . $escape_not_in_city . ' LIMIT 0, 1');
            $escape_city[] = $tmp_city[0]['tmp_cities']['id'];
            $tmp_state = $this->Bnbproperty->query('SELECT * FROM tmp_states WHERE id = ' . $tmp_city[0]['tmp_cities']['state_id']);
            $_data['Bnbproperty']['user_id'] = mt_rand(2, 10);
            $_data['Bnbproperty']['cancellation_policy_id'] = mt_rand(1, 3);
            $_data['Bnbproperty']['property_type_id'] = mt_rand(1, 12);
            $_data['Bnbproperty']['room_type_id'] = mt_rand(1, 3);
            $_data['Bnbproperty']['bed_type_id'] = mt_rand(1, 5);
            $_data['Bnbproperty']['city_id'] = $tmp_city[0]['tmp_cities']['id'];
            $_data['Bnbproperty']['state_id'] = $tmp_city[0]['tmp_cities']['state_id'];
            $_data['Bnbproperty']['country_id'] = $country_arr[$country];
            $_data['Bnbproperty']['title'] = $title[mt_rand(0, 7) ] . $tmp_city[0]['tmp_cities']['name'];
            $_data['Bnbproperty']['description'] = str_replace('.', '', $dummy['tmp_dummy_data']['description']);
            $_data['Bnbproperty']['accommodates'] = mt_rand(1, 16);
            $_data['Bnbproperty']['address'] = $dummy['tmp_dummy_data']['address'] . ', ' . $tmp_city[0]['tmp_cities']['name'] . ', ' . $tmp_state[0]['tmp_states']['name'] . ', ' . $tmp_country[0]['tmp_countries']['title'];
            $_data['Bnbproperty']['phone'] = $dummy['tmp_dummy_data']['phone'];
            $_data['Bnbproperty']['ip_id'] = 2;
            $price_arr = array(
                10,
                20,
                30,
            ...
            $_data['Bnbproperty']['price_per_night'] = $price_arr[mt_rand(0, 17) ];
            $_data['Bnbproperty']['price_per_week'] = ($_data['Bnbproperty']['price_per_night']*7) -10;
            $_data['Bnbproperty']['price_per_month'] = ($_data['Bnbproperty']['price_per_night']*30) -10;
            if ($_data['Bnbproperty']['accommodates'] > 3) {
                $_data['Bnbproperty']['additional_guest'] = $_data['Bnbproperty']['accommodates']-1;
                ...
                $_data['Bnbproperty']['additional_guest_price'] = $guest_price_arr[mt_rand(0, 9) ];
            }
            $_data['Bnbproperty']['backup_phone'] = $dummy['tmp_dummy_data']['backup_phone'];
            $_data['Bnbproperty']['house_rules'] = str_replace('.', '', $dummy['tmp_dummy_data']['house_rules']);
            $_data['Bnbproperty']['house_manual'] = str_replace('.', '', $dummy['tmp_dummy_data']['house_manual']);
            $size_arr = array(
                10,
                20,
                30,
            ...
            $_data['Bnbproperty']['property_size'] = $size_arr[mt_rand(0, 17) ];
            $_data['Bnbproperty']['measurement'] = mt_rand(1, 2);
            $_data['Bnbproperty']['minimum_nights'] = 1;
            $checkin_arr = array(
                '06:00:00',
                '06:15:00',
                '06:30:00',
            ...
            $_data['Bnbproperty']['checkin'] = $checkin_arr[mt_rand(0, 12) ];
            $checkout_arr = array(
                '18:00:00',
                '18:15:00',
                '18:30:00',
            ...
            $_data['Bnbproperty']['checkout'] = $checkout_arr[mt_rand(0, 12) ];
            $_data['Bnbproperty']['latitude'] = $tmp_city[0]['tmp_cities']['latitude'];
            $_data['Bnbproperty']['longitude'] = $tmp_city[0]['tmp_cities']['longitude'];
            $_data['Bnbproperty']['zoom_level'] = 10;
            $_data['Bnbproperty']['bed_rooms'] = mt_rand(1, 20);
            $_data['Bnbproperty']['beds'] = mt_rand(1, 20);
            $_data['Bnbproperty']['bath_rooms'] = mt_rand(1, 20);
            $_data['Bnbproperty']['is_active'] = ($dummy['tmp_dummy_data']['id']%50 == 0) ? 0 : 1;
            $_data['Bnbproperty']['is_approved'] = ($dummy['tmp_dummy_data']['id']%50 == 0) ? 0 : 1;
            $_data['Bnbproperty']['is_featured'] = ($dummy['tmp_dummy_data']['id']%30 == 0) ? 1 : 0;
            $_data['Bnbproperty']['is_verified'] = ($dummy['tmp_dummy_data']['id']%30 == 0) ? 1 : 0;
            $_data['Bnbproperty']['is_show_in_homepage'] = ($dummy['tmp_dummy_data']['id']%220 == 0) ? 1 : 0;
            $_data['Bnbproperty']['is_paid'] = ($dummy['tmp_dummy_data']['id']%30 == 0) ? 0 : 1;
            $_data['Bnbproperty']['video_url'] = $video_url[mt_rand(0, 4) ];
            $_data['Bnbproperty']['location_manual'] = str_replace('.', '', $dummy['tmp_dummy_data']['location_manual']);
            // amenities
            ...
            $_data['Bnbproperty']['id'] = '';
            $this->Bnbproperty->create();
            if ($this->Bnbproperty->save($_data)) {
                $property_id = $this->Bnbproperty->getLastInsertId();
                for ($i = 0; $i < 3; $i++) {
                    ...
                    $this->Bnbproperty->Attachment->Behaviors->attach('ImageUpload', Configure::read('Bnbproperty.file'));
                    $this->Bnbproperty->Attachment->isCopyUpload(true);
                    $this->Bnbproperty->Attachment->set($_attachment_data);
                    $this->Bnbproperty->Attachment->create();
                    ...
                    $this->Bnbproperty->Attachment->data = $_attachment_data['Attachment'];
                    $this->Bnbproperty->Attachment->save($_attachment_data);
                    $this->Bnbproperty->Attachment->Behaviors->detach('ImageUpload');
                    if ($image == 114) {
                        $image = 0;
                    } else {
    ...
    public function admin_action_taken()
    {
            ...
            $property_system_flagged_count = $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.is_system_flagged' => 1,
					'Bnbproperty.admin_suspend' => 0
                ) ,
            ...
            $property_user_flagged_count = $this->Bnbproperty->find('count', array(
                'conditions' => array(
                    'Bnbproperty.is_user_flagged' => 1,
					'Bnbproperty.admin_suspend' => 0,
                ) ,
            ...
            $request_system_flagged_count = $this->Bnbproperty->PropertiesRequest->Request->find('count', array(
                'conditions' => array(
            ...
            $request_user_flagged_count = $this->Bnbproperty->PropertiesRequest->Request->find('count', array(
                'conditions' => array(
        ...
        $pending_for_verification_count = $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_verified' => ConstVerification::WaitingForVerification
            ) ,
            'recursive' => -1
		...
		$pending_for_approval_count = $this->Bnbproperty->find('count', array(
            'conditions' => array(
                'Bnbproperty.is_approved' => 0
            ) ,
            'recursive' => -1
		...
		$request_pending_for_approval_count = $this->Bnbproperty->PropertiesRequest->Request->find('count', array(
            'conditions' => array(
                'Request.is_active' => 0
            ) ,
            'recursive' => -1
