...
class PropertyUserFeedbacksController extends AppController
{
    ...
    public function add() 
    {
        ...
        if (!empty($this->request->params['named']) || !empty($this->request->data['PropertyUserFeedback']['property_order_id'])) {
            ...
            $traveler = $this->User->find('first', array(
                'conditions' => array(
    ...
    {
        $this->pageTitle = __l('Feedback To Traveller');
        ...
        if (isset($this->request->data['PropertyUserFeedback']['q'])) {
            //$this->paginate['search'] = $this->request->data['PropertyUserFeedback']['q'];
    ...
    public function admin_edit($id = null) 
    {
        ...
        $this->pageTitle.= ' - ' . $this->request->data['PropertyUserFeedback']['id'];
    }
