...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			prevText: '<span class="ui-icon ui-icon-circle-triangle-w">&lt;Prev</span>', // Text for the previous month command
			prevStatus: 'Show the previous month', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Show the previous year', // Status text for the previous year command
			nextText: '<span class="ui-icon ui-icon-circle-triangle-e">Next&gt;</span>', // Text for the next month command
	...
	disable: function(target) {
		...
		if (inst.inline) {
			...
			$target.prepend('<div class="' + this._disableClass + '" style="' +
				'width: ' + inline.outerWidth() + 'px; left: ' + (offset.left - relOffset.left) + 'px; top: ' +
