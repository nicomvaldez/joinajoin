...
var themeRollerRenderer = {
	...
	'ui-widget-content datepicker-content ui-datepicker ui-helper-clearfix ui-corner-all{inline:start} ui-datepicker-inline{inline:end}">' +
	...
	'<div class="ui-datepicker-header ui-widget-header ui-datepicker-title ui-helper-clearfix ui-corner-all">{monthHeader:MM yyyy}</div>' +
