...
; (function($) {
    ...
    if (!DateDiff || typeof (DateDiff) != "function") {
        var DateDiff = function(interval, d1, d2) {
            ...
            switch (interval) {
                ...
                case "d": diff = 1;//Math.floor(t2 / 86400000) - Math.floor(t1 / 86400000); break;
    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildMonthDayEvent(e, cday, length) {
            ...
            var p = { color: '', title: "", extendClass: "", extendHTML: "", data: "" };
	...
	function weekshow(e, data) {
            ...
            if (data != null) {
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/></div></div></td></tr><tr><th class="cb-key"><span class="js-toggle-status">');
				temparr.push(i18n.xgcalendar.status, ':</span></th><td class="cb-value"><div class="textbox-fill-wrapper js-toggle-status"><div class="textbox-fill-mid js-status"></div></div>');
                ...
                temparr.push(i18n.xgcalendar.update_detail, '" class="submit-button" type="button"/>');
				temparr.push('<input id="bbit-cal-quickConfirmBTN" value="Confirm" class="submit-button" type="button"/>');
				temparr.push('<input id="bbit-cal-quickRejectBTN" value="Reject" class="submit-button" type="button"/>');
				temparr.push('<div id="bbit-cal-quickNegotiateBTN" class="cancel-block"><a href="' + __cfg('path_absolute') + 'activity/' + data[0] + '">Negotiate</a></div>');
                ...
                temparr = null;
					...
					else if(data[9]==2 || data[9]==5 || data[9]==7 || data[9]==6 || data[9]==8) // Already Booked only show the informatino
					{
					...
					else if(data[9]==51) // Negotiated information
					{
					$(".js-status").html(data[1]);
					...
					else if(data[9]==1) //waiting for acceptance
					{
					 html +='<select class="js-select">';
					 var status_id=2; // default selection
					 for(var k=2;k<=3;k++)
						{
						  var caption;
						  if(k==2)
                ...
                $("#bbit-cal-quickAddBTN, #bbit-cal-quickConfirmBTN, #bbit-cal-quickRejectBTN").click(function(e) {
                    ...
                    var param = [{ "name": "id", value: primary_id },
						{ "name": "property_id", value: property_id },
						{ "name": "stpartdate", value: datestart },
						{ "name": "etpartdate", value: dateend },
						{ "name": "price", value: price },
						{ "name": "status", value: status },
						{ "name": "Description", value: desc },
						{ "name": "model", value: model },
						{ "name": "colorvalue", value: color },
						{ "name": "timezone", value: zone}];
            ...
            $("#bbit-cal-end").val(dateFormat.call(data[3], i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm"));
                    ...
                    if (!option.ViewCmdhandler) {
						...
						//not editiable bubble reurn false set
						return false;
                        if (option.ViewCmdhandler && $.isFunction(option.ViewCmdhandler)) {
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.create_event, '" type="button" class="submit-button"/>');
                temparr.push('</div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div>');
                var tempquickAddHanler = temparr.join("");
                temparr = null;
            ...
            if (viewtype == "week" || viewtype == "day") {
				...
				$("td.st-moreul", gridcontainer1).each(function(i) {
                    ...
                    $(this).click(function(e) {
                        weekmoreshow.call(this, $(this).parent().parent().parent().parent()[0]); return false;
