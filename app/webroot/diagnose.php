...
$facebook_settings_id = 48;
$twitter_settings_id = 49;
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Burrow - Diagnostic Tool</title>
<style type="text/css">
body{
	color:#4c4c4c;
	line-height:18px;
            ...
            foreach($db_info['payment_gateway']['gateway'] as $key => &$gateway) {
                foreach($db_info['payment_gateway']['gateway_settings'] as &$settings) {
                    if ($gateway['id'] == $settings['payment_gateway_id']) {
                        if (($settings['key'] != 'is_enable_for_property_listing_fee' && $settings['key'] != 'is_enable_for_property_verified_fee' && $settings['key'] != 'is_enable_for_add_to_wallet' && $settings['key'] != 'is_enable_for_book_a_property' && $settings['key'] != 'is_enable_for_signup_fee')) {
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=burrow-install#setting_up_files" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=burrow-install#setting_up_files</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=burrow-install#setting_up_database" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=burrow-install#setting_up_database</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=burrow-install#manage_settings" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=burrow-install#manage_settings</a>
	</span>
</p>
<?php
...
<table border="2" class="list">
  ...
  <tr>
    ...
    <th>Active?</th>
    <th>Live mode?</th>
    <th>Enable for Property Listing?</th>
    <th>Enable for Property Verification?</th>
    <th>Enable for Book Property?</th>
    <th>Enable for Signup Fee?</th>
...
?>
  <tr>
    ...
    <td><?php
        echo ($gateway['is_enable_for_property_listing_fee']) ? 'Yes' : 'No'; ?></td>
    <td><?php
        echo ($gateway['is_enable_for_property_verified_fee']) ? 'Yes' : 'No'; ?></td>
	<td><?php
        echo ($gateway['is_enable_for_book_a_property']) ? 'Yes' : 'No'; ?></td>
	<td><?php
        echo ($gateway['is_enable_for_signup_fee']) ? 'Yes' : 'No'; ?></td>
    <td><?php
...
<table width="400" border="2" class="list">
    ...
    $setting_labels = array(
        ...
        'pagseguro_payee_account' => 'PagSeguro Account',
...
?>
                    ...
                    if ($setting['key'] != 'masspay_API_Password' && $setting['key'] != 'masspay_API_Signature' && $setting['key'] != 'adaptive_API_Signature' && $setting['key'] != 'adaptive_API_Password' && $setting['key'] != 'authorize_net_trans_key' && $setting['key'] != 'pagseguro_token') {
